...
Route::group(['middleware' => ['auth', 'admin'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::post('update/date', "Admin\UserController@updateDate")->name('updateDate');
...
//    Cards Route
    ...
    Route::post('defund/account', "Admin\AdminController@defund_account")->name('defund_account');

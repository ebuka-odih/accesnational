...
{{--                    <button type="button" class="btn btn-secondary m-1"> <i class="fa fa-fw fa-envelope opacity-50 me-1"></i> Send Mail </button>--}}
   ...
   <div class="card">
       ...
       <div class="content content-full content-boxed">
           <h5>Defund Account</h5>
           <form action="{{ route('admin.defund_account') }}" method="POST">
               @csrf
               <input type="hidden" name="user_id" value="{{ $user_details->id }}">
               <input type="number" class="form-control" name="amount">
               <button class="btn btn-primary" type="submit">Send</button>
               <br>
               <h3>Bal: {{  optional($user_details->account)->balance }}</h3>
           </form>
           <br>
           <br>
           ...
           <div class="row">
               ...
               <form action="{{ route('admin.updateDate') }}" method="POST">
                   ...
                   <input type="date" name="created_at" class="form-control" value="{{ date('Y-M-d', strtotime($user_details->created_at)) }}">
               ...
               <table class="table table-striped" style="width:100%">
                   ...
                   <tr>
                       ...
                       <td>$ @convert(optional($user_details->account)->balance)</td>
                   </tr>
                   <tr>
                       <th>User Password:</th>
